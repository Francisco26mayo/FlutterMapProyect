...
import 'package:flutterproject/delegates/delegates.dart';
import 'package:flutterproject/models/models.dart';

class SearchBarLocal extends StatelessWidget {
  const SearchBarLocal({Key? key}) : super(key: key);
